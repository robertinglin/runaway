...
slidesContainerID      = ".slideshow";
slidesControlsID       = ".slideshow-controls";
slideDelay             = 5000;
...
function setUpSlideShow()
{
    ...
    slidesCollection = document.querySelector(slidesContainerID).children;
    slidesControllersCollection = document.querySelector(slidesControlsID).children;
    ...
    for (var i=0; i < slidesCollection.length; i++)
    {
        ...
        slidesControllersCollection[i].onclick = function(e){e.preventDefault();clickSlide(this);return false;};
...
function transSlide()
{
    ...
    crtSlide.style.left = - ( opacity ) * 100 + "%";
    
    // fade in the next slide
    nextSlide.style.left = ( 1 - opacity ) * 100 + "%";
